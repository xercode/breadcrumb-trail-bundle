...
final class Trail implements \IteratorAggregate, \Countable
{
    /**
     ...
     */
    public function __construct(UrlGeneratorInterface $router, ContainerInterface $container, ?string $templateName = 'xeBookBreadcrumbTrailBundle::breadcrumbtrail.html.twig')
    {
        $this->router = $router;
